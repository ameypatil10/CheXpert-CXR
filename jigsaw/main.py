...
if args.mode == 'test':
    auc = test(['../model/{}model.best'.format(hparams.exp_name)], data=(hparams.test_csv, hparams.valid_dir))
    print(auc)

if args.mode == 'valid':
    auc = test(['../model/{}model.best'.format(hparams.exp_name)], data=(hparams.valid_csv, hparams.valid_dir))
    print(auc)
