...
#             0: 'No Finding',
        ...
        self.gpu_device = torch.device("cuda:3" if torch.cuda.is_available() else "cpu")
        self.device_ids = [3,4]
        ...
        self.jigsaw_path = None #'../model/jigsaw-densenet/model.best'

        ################################################################################################################################################
        self.exp_name = '/baseline-inceptionv3-u1/'
        ################################################################################################################################################
